...
id: build-system
title: Build System
path: ['/community/development/technical-documentation/development/build-system']
keywords: ['build', 'vinxi', 'vite', 'webpack', 'rust', 'webassembly', 'compilation', 'bundling', 'optimization']
tags:
  - build-system
  - vinxi
  - vite
...
- **[Development Setup](./development-setup)** - Setting up the build environment
- **[Desktop Application](./desktop-application)** - Tauri build configuration and native compilation
- **[Deployment Guide](./deployment-guide)** - Production build deployment
- **[Core Business Logic](../core/core-business-logic)** - Understanding Rust components
