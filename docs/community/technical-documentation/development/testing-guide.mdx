...
id: testing-guide
title: Testing Guide
path: ['/community/development/technical-documentation/development/testing-guide']
keywords: ['testing', 'unit tests', 'integration tests', 'e2e', 'vitest', 'cypress', 'audio testing', 'real-time testing']
tags:
  - testing
  - quality-assurance
  - vitest
...
- **[Development Setup](./development-setup)** - Set up testing environment
- **[Frontend Architecture](../frontend/frontend-architecture)** - Understand component structure
- **[Audio System](../frontend/audio-system)** - Learn audio testing specifics
