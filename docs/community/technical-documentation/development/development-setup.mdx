...
path: ['/community/development/technical-documentation/development/development-setup']
keywords: ['development', 'setup', 'environment', 'installation', 'dependencies', 'tools', 'configuration', 'getting started']
tags:
  - development
  - setup
  - environment
...
1. **Read Architecture Overview**: Start with [Architecture Overview](../core/architecture-overview)
2. **Understand Frontend**: Review [Frontend Architecture](../frontend/frontend-architecture)
3. **Learn Testing**: Follow [Testing Guide](./testing-guide)
4. **Explore Core Engine**: Study [Core Business Logic](../core/core-business-logic)
...
5. **Desktop Development**: See [Desktop Application](./desktop-application) for native app development
