...
1. **Read Architecture Overview**: Start with [Architecture Overview](./architecture-overview)
2. **Understand Frontend**: Review [Frontend Architecture](./frontend-architecture)
3. **Learn Testing**: Follow [Testing Guide](./testing-guide)
4. **Explore Core Engine**: Study [Core Business Logic](./core-business-logic)
