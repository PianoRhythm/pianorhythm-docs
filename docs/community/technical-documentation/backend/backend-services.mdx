...
path: ['/community/development/technical-documentation/backend/backend-services']
keywords: ['backend', 'api', 'rest', 'websocket', 'mongodb', 'authentication', 'oauth', 'database', 'server']
tags:
  - backend
  - api
  - database
...
- **[WebSocket Communication](./websocket-communication)** - Real-time communication details
- **[Deployment Guide](../development/deployment-guide)** - Production deployment strategies
- **[Testing Guide](../development/testing-guide)** - Backend testing strategies
