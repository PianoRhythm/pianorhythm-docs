...
In the chat bar, type `/nickname <new nickname>` to change your nickname. For example, `/nickname PianoRhythmFan`.
To clear it, type `/nickname` or `/clear_nickname`.

You can find more information about chat commands [here](/guides/general/commands).
